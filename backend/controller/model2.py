...
# Recommendation 
###############################################################################
# Instead of directly merging the Search Bar and the resources in NLP,
# seperate the oeprations of the two into two aggregate roots.
# Then create a new class (ex. def launch_answer(): ) that only holds the final request/answer 
# to the questions being asked by the user. 
