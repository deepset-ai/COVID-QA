...
class CovidScraper(scrapy.Spider):
  ...
  start_urls = ["https://www.zusammengegencorona.de/informieren/basiswissen-coronavirus/", 
                ...
                "https://www.zusammengegencorona.de/informieren/wirtschaftliche-folgen/", # not real answers, only links...
                "https://www.zusammengegencorona.de/informieren/weitere-informationen/",  # very specific questions and answers as well as other links
  ...
  def parse(self, response):
    ...
    columns["name"] = ["Ihre Fragen - unsere Antworten zum neuartigen Coronavirus / COVID-19"] * len(columns["question"])
