  ...
  def parse(self, response):
    ...
    for node in all_nodes:
      ...
      if node.attrib.get("class") != "row d-none d-lg-block":
        # unnecessary block
        if (node.attrib.get("class") in ["card-body ", "card bt-3 bt-primary mb-3", "card bt-3 bt-secondary mb-3"]):
          unnecessary = True
          continue
    ...
    columns["link"] = ["https://www.cdc.gov/coronavirus/2019-ncov/prepare/pregnancy-breastfeeding.html"] * len(columns["question"])
