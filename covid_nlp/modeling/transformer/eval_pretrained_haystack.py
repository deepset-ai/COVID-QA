...
class pre_transform_class:
    def __init__(self, eval_file, lang, models, pooling_methods, extraction_layers):
        ...
        for model_name in models:
            for pooling_method in pooling_methods:
                for extraction_layer in extraction_layers:
                    ...
                    eval.eval_ques_sim().eval_question_similarity(y_true=y_true, y_pred=df["pred"].values, lang=lang, model_name=model_name,
                                         params=params, user="malte", log_to_mlflow=log_to_mlflow, run_name=experiment_name)
...
#    models = ["deepset/sentence_bert","bert-base-uncased", "DeepPavlov/bert-base-multilingual-cased-sentence"]
    ...
    #Added aggregation along with reference updates
    pre_transform_class.eval_pretrained_transformers(eval_file, lang, models, pooling_methods, extraction_layers)